...
app.layout = html.Div(className='content', children=[
    ...
    html.Main(className='page-container', children=[
        ...
        html.H2("Évolution temporelle des passages à vélo de 2019 à 2023"),
        ...
        html.H2("viz 2"),
        html.P("Cette section aborde l'achalandage moyen par heure des quatre saisons."),
        dcc.Graph(
            id='polar-bar-chart',
            config=figure_config
        ),
        ...
        html.H3("L'influence de la température"),
        dcc.Graph(
            id='scatter-plot-temperature',
            config=figure_config
        ),
        ...
        html.H3("L'influence de la quantité de neige tombée"),
        dcc.Graph(
            id='scatter-plot-snow',
            config=figure_config
        ),
        ...
        html.H3("L'influence de la quantité de pluie tombée"),
        dcc.Graph(
            id='scatter-plot-rain',
            config=figure_config
        ),
