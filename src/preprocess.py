...
# Determination de nombre quotidien de passage par vélo et formatage des dates
...
def get_season(month):
    if month in [12, 1, 2]:
        ...
        return 'Automne'
 # Regroupement de la base de données en fonction de l'heure, saison et nombres de passages
...
# Visualisation 3 : Carte des compteurs et pistes cyclables
...
# Visualisation 4 : ScatterPlot
 # Traitement et fusion des données de comptage avec les données météorologiques
